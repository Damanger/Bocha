    ...
    return (
        <nav className={Style.navbar}>
            ...
            <div className={`${Style.navLinks} ${isMenuOpen ? Style.showMenu : ''}`}>
                <Link to="/" activeclassname="activo" className={Style.navLink} style={location.pathname === "/" ? activeStyle : {}} onClick={closeMenu}><FontAwesomeIcon icon={faHome} className={Style.homeIcon} /></Link>
